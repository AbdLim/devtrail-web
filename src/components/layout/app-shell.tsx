...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#090B0A] text-[#F4F1E8] font-sans antialiased overflow-hidden">
      ...
      <div className="relative z-10 flex h-full">
        ...
        <div className="flex flex-1 flex-col min-w-0 h-full">
          ...
          <div className="flex flex-1 min-h-0 h-full overflow-hidden">
            ...
            <main
              className={`flex-1 overflow-y-auto px-10 py-8 pb-24 ${!inspector.isOpen ? 'mx-auto' : ''}`}
              style={{
                maxWidth: inspector.isOpen ? "none" : "1100px",
              }}
            >
              {children}
            </main>
